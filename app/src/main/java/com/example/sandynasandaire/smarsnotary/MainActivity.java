...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView btnMeeting = (CardView) findViewById(R.id.btnMeeting);
        ...
        CardView btnNewsPaper = (CardView) findViewById(R.id.btnNewsPaper);
        ...
        CardView btnAnnuaire = (CardView) findViewById(R.id.btnAnnuaire);
        ...
        CardView btnApropos = (CardView) findViewById(R.id.btnApropos);
